...
$registro=mysqli_query($mysqli  ,"UPDATE `usersSiwCargo` SET `name` = '$request->name', `password` = '$request->password ', `email` = '$request->email',
`rol` = '$request->rol' WHERE `usersSiwCargo`.`id` = '$request->id';");
